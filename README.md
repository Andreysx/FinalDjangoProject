...
1. Клонируйте репозиторий на ваше устройство:
    ...
    ```bash
    git clone https://github.com/Andreysx/FinalDjangoProject.git
    ```
...
- Категории добаляются админом по умолчанию
...
- Оформление сделано на основе готовых стилей Bootstrap


## Проект функционирует по адресу : 

[andreykasx.pythonanywhere.com](https://andreykasx.pythonanywhere.com/)